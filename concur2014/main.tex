...
Figure~\ref{fig:cp-typing} gives type typing rules for \mucp.
...
\end{equations}%
where we write $FV(P)$ for the set of free variables of the process $P$.
...
* explain send \vec{x}, \x y, \x \vec{x} sugar?
