...
type $T$ is represented as a \mucp coinvariant of type $\tocp{T} \otimes \outterm$, where rely
on syntactic sugar for output along a channel: $x[y].P \equiv x[y'].(\link{y}{y'} \mid P)$.
\]
