...
obtain the result (13) and close the channel.
...
The exponential connectives $!$ and $?$ provide servers and services. The process $!x(y).P$ defines
the behavior of a server $x$. It accepts a channel $y$ which is bound in $P$. The process $?x[y].P$
sends channel $y$ to the server associated with $x$, and then continues as $P$.
