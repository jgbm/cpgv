...
provides definition of (co)recursive sessions. The body $M$ provides one iteration of the recursion.
Thus, it has access to the coinvariant $x_i$, a channel $G(X)$, and limited (co)recursive use of $f$;
