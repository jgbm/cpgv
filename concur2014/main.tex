...
* consider dropping the mu introduction rule - we don't need it in any of our examples because we
always get a mu session by an invocation of fork with a nu session
