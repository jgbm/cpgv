...
\todo{Annotate corec with the functor?}
...
The translation is the same as in our previous work~\cite{LindleyM14} except for the translation of
recursion and corecursion, which is new.

\todo{Explain the translation}
...
\todo{explain what the hell ``functoriality result'' means}
