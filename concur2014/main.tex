...
\item Finally, we show that programs in \mugv correspond to proofs in \mucp, in two stages.  First,
  ...
  features~\secref{gvtogvpi}; we call the resulting restricted language \mugvpi.  Second, we show
  that programs in \mugvpi can be translated to terms of \mucp~\secref{gvpitocp}.
\end{itemize}
