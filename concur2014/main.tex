...
\newcommand{\corec}[5]{\mkwd{corec}^{#3}\:#1 \langle #2 \rangle (#4,#5)}
...
\tocp{\gvtyp{\Phi}{M}{G(\mu G)}}z &=&
  \cut{y}{\nu \tocp{G}}{\tocp{M}y}{\rec{y}.\link{y}{z}} \\
\end{equations}%
\vspace{-1ex}
%% \[
%% \shade{
...
\key{new}\:y\:
  ...
  \el \\ \shaderow
\tocp{\gvtyp{\Phi}{M}{\nu G}} &=&
  \cut{y}{\nu \tocp{G}}{\tocp{M}y}{\rec{z}.\link{y}{z}} \\
\end{equations}%
%% \[
%% \shade{
...
\el
\]
where $E = \map{F}{z,x}{\corec{z}{y}{}{\link{x}{y}}{Q[z/x]}}$.
