...
\cptogv{\cpEmptyIn{x}{P}} &=&
  \gvLet{\gvUnit}{\gvTerminate{x}}{\cptogv{P}} \\[1ex]
...
a CP term. Perhaps we can do better, though, by performing a kind of
local CPS transformation.

% channel passing translation
\newcommand{\cps}[1]{({#1})^\star}

\begin{equations}
\cps{\gvLinFun{T}{U}} &=& \gvInput{\gvDual{\cps{T}}}{\cps{U}} \\
\cps{\gvUnFun{T}{U}} &=& \gvServer{(\gvInput{\gvDual{\cps{T}}}{\cps{U}})} \\
\cps{\gvTimes{T}{U}} &=& \gvOutput{\gvDual{\cps{T}}}{\cps{U}} \\
\cps{\gvUnitType} &=& \gvServer{(\gvChoice{}{})} \\
\end{equations}

\begin{equations}
\cps{\gvj{\Phi}{M}{T}} &=& \gvj{\cps{\Phi}}{\cps{M}}{\cps{T}} \\
\end{equations}


\begin{equations}
\cps{\gvLam{x}{M}} &=& \gvWith{z}{\gvLet{\gvPair{x}{z}}{\gvReceive{z}}{\gvLink{\cps{M}}{z}}}{z} \\
\cps{\gvApp{L}{M}} &=&
    \gvWith{y}
       {\gvLink{\cps{L}}{y}}
       {\gvSend{\cps{M}}{y}} \\
