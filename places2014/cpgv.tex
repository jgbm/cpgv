...
\gvtocp{\gvOutputType{X}{\SE}}     &=& \cpForall{X}{\gvtocp{\SE}} \\
\gvtocp{\gvInputType{X}{\SE}}      &=& \cpExists{X}{\gvtocp{\SE}} \\[1ex]
...
Terms
\begin{equations}
\gvtocp{\gvSendType{\SE}{(M : \cpForall{X}{S'})}}z &=&
  \cpCut{(x:\cpExists{X}{\cpDual{\gvtocp{S'}}})}{\cpSendType{x}{\gvtocp{\SE}}{\cpLink{x}{z}}}{\gvtocp{M}x} \\
