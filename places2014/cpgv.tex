...
a core session-typed linear functional language, GV, patterned after the similar language of Gay and
...
choice ($\binampersand$) types are $n$-ary, corresponding to corresponding session types in \hgv{}.
