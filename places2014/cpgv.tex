...
We present the typing rules of CP in Figure~\ref{fig:cp-typing}. The cut relation $\redto$ for CP is
given in Appendix~\ref{sect:cp-cut}.
%Due to lack of space we omit the definition of the cut relation $\redto$.
A detailed description of CP
%, including the cut rules,
can be found in Wadler's work~\cite{Wadler12}. Note that the propositions of CP are exactly those of
