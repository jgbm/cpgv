...
\newcommand{\cevalstar}{\Longrightarrow}
...
\newcommand{\case}[2]{\mkwd{case}\:#1\:\{#2\}}
...
\newcommand{\gvendpoint}[4]{#1(#2) \leftrightsquigarrow #3(#4)}
\newcommand{\gvbuf}[3]{#1\overrightarrow{#2}#3}
...
%\newcommand{\boringcut}[4]{{\color{red}\nu#1 \: (#3 \mid {\color{black}#4})}}
\newcommand{\boringcut}[4]{\shade{\nu#1 \: (#3 \mid\,}\color{black}#4\shade{)}}
