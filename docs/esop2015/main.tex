...
\todo{perhaps improve the following paragraph}

Session types were originally developed for process calculi, such as the $\pi$-calculus. Recent work
has adapted session types to more practical programming languages. In this paper, we are
particularly interested in the use of session types for concurrency in functional programming
languages, as developed by Vasconcelos et al.~\cite{VasconcelosGR06} and by Gay and
...
\end{equations}
\caption{Translation of GV terms and configurations into CP}\label{fig:from-gv}
\end{figure}
