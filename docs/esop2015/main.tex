...
\todo{Probably scrap this, as it turns out to be quite hard to prove correct directly.}
...
\tocp{\lambda x.M}z &=& z(x).\tocp{M}z \\
\tocp{L \app M}z &=&
  \cut{y}{}{\tocp{L}y}{\cut{x}{}{\tocp{M}x}{y[x].\link{y}{z}}} \\
%% \tocp{L \app M}z &=&
...
\begin{theorem}
If $\Gamma \vdash M \teval N : T$, then $\tocp{M}z \rto^* \tocp{N}v$.
\end{theorem}
