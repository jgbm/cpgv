...
provides the captured substitution.  We extend the typing relation on terms to include closures, as
follows:
\[
\inferrule
...
do not).  We designate the main thread in a configuration by surrounding it in brackets
$\distinguish M$.
...
\cut{x}{A \oplus B}{\sel{x}{in_i}.P}{\case{x}{Q_1; Q_2}}
  &\rto&
    \cut{x}{A}{P}{Q_i} \\
\cut{x}{}{P_1}{Q} &\rto& \cut{x}{}{P_2}{Q}, \quad \text{if $P_1 \rto P_2$}
\end{equations}%
