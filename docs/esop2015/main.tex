...
\begin{proof}
  ...
  \]
  Since $n \geq 2$, any configuration $C'$ containing the $M_i$ must partition the cycle.  However,
  any cut of the cycle is crossed by at least two channels, so such a $C'$ must be ill-typed by
