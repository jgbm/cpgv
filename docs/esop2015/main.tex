...
%
Following our previous work~\cite{places}, the translation on functional types is factored through
...
work~\cite{jfp,places}. One problem with the old translation is that they it does not reflect
...
Finally, we prove that all reductions in GV are preserved by $\tocp{C}$.
%
...
rather than simulating standard reduction.  Wadler~\cite{Wadler12} adapts the approach of Caires and
