...
\todo{What about a progress theorem? What would a progress theorem look like?  The following seems
  ``too syntactic'' for my taste.}
...
\begin{theorem}
  ...
  the canonical form of $P$.  Then we have that:
  \begin{enumerate}
  \item For $1 \leq i \leq n - 1$ either $\blockedp(x_i,M_i)$ or $\blockedp(y,M_i)$ for some $y \in \dom(\Gamma)$; and,
  \item Either $M_n$ is a value or $\blockedp(y,M_n)$ for some $y \in \dom(\Gamma)$.
  \end{enumerate}
\end{theorem}
