...
\usepackage{amsmath,amssymb,centernot,colortbl,hyperref,mathwidth,scalerel,stmaryrd,url,xspace,mathrsfs,enumitem,bm}
...
\begin{syntax}
  ...
  \text{Types} & T,U & ::= & S \mid T \gvtimes U \mid \one \mid T \gvplus U \mid \zero \mid T \lto U \\ % \mid {!T} \\
