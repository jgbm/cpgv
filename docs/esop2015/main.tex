...
by $\gvconst{fork} \app f$, the session returned from $f$ is implicitly closed by $\gvconst{fork}$;
however, the other end of the channel must be explicitly closed by calling \gvconst{wait}.  So a
...
negate one:
%
\[\begin{array}{l@{\quad\vrule\quad}l}
\bl
  \mkwd{offer} \: z \: \{ \:
  \bl
