...
cut [x:Church] (Zero(x) | Ping(x,y,w)) |- y:?bot,w:1.
cut [x:Church] (One(x) | Ping(x,y,w)) |- y:?bot,w:1.
cut [x:Church] (Two(x) | Ping(x,y,w)) |- y:?bot,w:1.
type Top = &{}.
cut [y1 : !Top * !Top] (foo <-> y1 |  y1(x2).!z0(y3).case y3(){}) |- foo : ~(!Top * !Top),z0:!Top.
